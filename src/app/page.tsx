// Landing pública de VestIA (/).
// Server Component: solo HTML/CSS estático. El Proxy redirige a /wardrobe
// si el usuario ya tiene sesión activa, así que esta página solo la ven
// usuarios nuevos o visitantes sin cuenta.
